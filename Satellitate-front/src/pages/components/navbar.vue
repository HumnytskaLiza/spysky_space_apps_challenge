<template>
  <div id="navbar">
    ...
    <ul>
      <div class="nav-links">
        <a href="#about-us-block" id="no-underline"><li>About Us</li></a>
        <a href="#our-mission-block" id="no-underline"><li>Our Mission</li></a>
        <a href="#pricing-block" id="no-underline"><li>Pricing</li></a>
        <a href="#contact-us-block" id="no-underline"><li>Contacts</li></a>
      </div>
      ...
      <div class="nav-buttons" v-show="logged">
        <div id="user" @click.stop="showDropdown()">
          <img
            src="../../assets/icons/test_profile_photo.png"
            id="user-photo"
          />
        </div>
      </div>
      ...
      <div id="burger-container">
        <div
          ...
          :class="{ opened: isBurgerDropdownVisible }"
        >
          <img src="../../assets/icons/burger.svg" alt="" />
        </div>
        <div id="nav-bm-dropdown" v-show="isBurgerDropdownVisible">
          <a href="#about-us-block" id="no-underline"><div>About Us</div></a>
          <a href="#our-mission-block" id="no-underline"
            ><div>Our Mission</div></a
          >
          <a href="#pricing-block" id="no-underline"><div>Pricing</div></a>
          <a href="#contact-us-block" id="no-underline"><div>Contacts</div></a>
        </div>
      </div>
    </ul>
  </div>
