    ...
    <div class="hero-container">
      <div class="hero-overlay">
        ...
        <div class="hero-nav">
          ...
          <div class="nasa-data">
            <p><b>Based on NASA open data</b></p>
          </div>
          <router-link to="/3d-map" id="no-underline">
            <button class="fill">Explore the 3D map</button>
          </router-link>
        </div>
      </div>
      <img
        src="../../assets/background-textures/lines.png"
