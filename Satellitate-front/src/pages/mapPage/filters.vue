<template>
  <div id="left-filters">
    <div
      class="filters"
      v-bind:class="{ filters: true, 'filters--collapsed': areFiltersVisible }"
    >
      ...
      <div>
        ...
        <div class="satellite-names">
          <p id="selected-name" @click.stop="showNamesDropdown()">
            {{ selectedName }}
          </p>
        ...
        <div class="object-ids">
          <p id="selected-id" @click.stop="showIdsDropdown()">
            {{ selectedId }}
          </p>
          <img src="../../assets/icons/caret-down-fill.svg" />
        ...
        <button id="clear-filters" class="fill" @click="clearFilters()">
          Clear filters
        </button>
      </div>
      ...
      <div class="range-slider-container">
        ...
        <div id="slider">
          ...
          <div class="range-input">
            <input type="range" class="range-min" min="0" max="4" value="0" />
            <input type="range" class="range-max" min="0" max="4" value="4" />
          </div>
        </div>
  ...
  methods: {
    ...
    clearFilters() {
      ...
      const progress = document.querySelector(
        ".range-slider-container #progress"
      );
    ...
    getEpochs() {
      let id = 0;
      let timeDiff =
        new Date(this.maxValue).getTime() - new Date(this.minValue).getTime();
